...
- **Conversion/AOV features live in theme:** unbranded Buy-it-now + solid Add-to-cart, PDP trust line + Delivery/Use collapsible tabs + "Pairs well with" complementary block (empty until Search & Discovery pairs are set) + "You may also like", cart free-delivery progress bar (£40 goal) + low-ticket cross-sell + trust block, sticky header on scroll-up, helpful 404, Organization JSON-LD.
